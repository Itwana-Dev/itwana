...
export default function LicensesSection() {
  ...
  return (
    <section id="licenses" className="pt-24 md:pt-32 lg:pt-40 relative">
      {/* Adornos de Radial Gradient */}
      <div className="absolute inset-0 z-[-1] pointer-events-none">
        <div
          className="absolute top-0 right-0 w-[150px] h-[150px] rounded-full"
          style={{
            background:
      ...
      <div className="container">
        <div className="border-b border-body-color/[.15] pb-16 dark:border-white/[.15] md:pb-20 lg:pb-28">
          <div className="-mx-4 flex flex-wrap items-center">
            {/* Columna de Imagen: se muestra a la izquierda en dispositivos grandes */}
            <motion.div
              className="w-full px-4 lg:w-1/2 order-2 lg:order-1"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeInUp}
            ...
            >
              <div className="relative mx-auto aspect-[25/24] max-w-[500px]">
                <Image
                  src="/images/services/asesorias.png"
                  alt="Licencias y Asesorías"
                  fill
                  quality={100}
            ...
            {/* Columna de Texto */}
            <motion.div
              className="w-full px-4 lg:w-1/2 order-1 lg:order-2"
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true }}
              variants={fadeInUp}
            ...
            >
              <SectionTitle
                title="Licencias y Asesorías"
                paragraph="Asesoramos y brindamos licencias flexibles para impulsar el crecimiento tecnológico, ofreciendo soluciones adaptadas a cada necesidad con implementación rápida y soporte experto."
                mb="44px"
              />
